...
// Represents a received trap record from table trap_history.
public class TrapHistory {
    ...
    public Long getTrapActionId() {
        return trapActionId;
    }

    public void setTrapActionId(Long trapActionId) {
        this.trapActionId = trapActionId;
    }
